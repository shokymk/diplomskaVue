  ...
  <div class="submit-form">
    <div v-if="!submitted">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="name" required v-model="event.name" name="name" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <datetime type="datetime" input-class="form-control" v-model="event.date"></datetime>
        <input type="hidden" name="date" v-validate="'required'" v-model="event.date" />
      </div>
      <div class="form-group">
        <label for="name">Event location</label>
        <br>
        <gmap-autocomplete class="form-control" v-on:place_changed="getAddressData">
